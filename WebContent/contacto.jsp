            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  ...
                  <p class="mb-5" data-aos="fade-up"  data-aos-delay="100">Si quieres saber más sobre RecApp, o si quieres preguntarnos algo, <br>estamos a tu completa disposicion</p>  
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-4 ml-auto order-2"  data-aos="fade-up">
                <ul class="list-unstyled">
                  <li class="mb-3">
                    ...
                    <span>Julián Camarillo 45, 28029 Madrid España</span>
                  </li>
                  <li class="mb-3">
