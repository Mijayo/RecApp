			...
			<div class="container">
				<div class="row align-items-center ">
					...
					<div class="mr-auto" style="max-width: 600px; margin-top: -20px;">
						...
						<form class="" action="GestionPreguntas?option=extra"
							method="POST">
							<div style="position: relative;">
<!-- TITULO START                                   ////////////////////////////////////////////////////////////////////// -->
								<h2 class="mb-4" style="color: white;">
									<span>Algunas preguntas más... </span>
								</h2>
<!-- TITULO ENDS                                   ////////////////////////////////////////////////////////////////////// -->
							</div>
										...
										<table>
											<tr>
												...
												<td><input
													...
													type="checkbox" name="isbn" value="${preguntaA.idAux}"
													checked ></td> 	
												<td><p
												...
												<td><select name="cantidad${preguntaA.idPregunta}">
														...
														<option value="5">5</option>
																...
																<c:forEach items="${requestScope.preguntaB}" var="preguntaB"
									begin="5" end="6">
									<div style="display: flex;">
										<table>
											<tr>
