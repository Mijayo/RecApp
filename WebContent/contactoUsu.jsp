			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-md-6 mr-auto text-center text-md-left mb-5 mb-md-0">
						<h2>Y si vas a contactarnos para criticar tenemos otra forma
							de contacto</h2>
					</div>
					<div class="col-md-5 text-center text-md-right">
						<p>
							<a href="#" class="btn"><span
								class="icofont-brand-apple mr-3"></span>Te la metes por el culo</a>
							<a href="#" class="btn"><span class="icofont-ui-play mr-3"></span>Y
								soplas</a>
						</p>
					</div>
				</div>
